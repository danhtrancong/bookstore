...
@Transactional
public class ProductIDaoImlp extends AbstractDao<ProductEntity> implements ProductDao {

	static final Logger logger = LoggerFactory.getLogger(ProductIDaoImlp.class);
